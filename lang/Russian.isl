...
SelectTasksLabel2=Выберите компоненты для установки и необходимые действия:
...
FinishedLabelNoIcons=Работа [name] по подготовке системы согласно требований Open Server Panel завершена.
...
Runexe=Запустить Open Server Panel
...
MSVC=Обязательные компоненты Microsoft
...
OsCoreComp=Панель управления
OsServer=Веб-серверы
OsWTools=Веб-приложения
