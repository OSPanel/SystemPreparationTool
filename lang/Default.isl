...
InstallingLabel=Please wait while the system is being prepared.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Completing the [name] Setup Wizard
FinishedLabelNoIcons=[name] 's work on preparing the system according to the requirements of the Open Server Panel has been completed.
FinishedLabel=Setup has finished installing [name] on your computer. The application may be launched by selecting the installed shortcuts.
ClickFinish=Click Finish to exit Setup.
FinishedRestartLabel=To apply the changes, Setup must restart your computer. Would you like to restart now?
FinishedRestartMessage=To apply the changes, Setup must restart your computer.%n%nWould you like to restart now?
