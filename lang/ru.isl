...
WizardSelectTasks=Подготовка системы к работе с Open Server Panel
SelectTasksDesc=Установка дополнительных системных компонентов
SelectTasksLabel2=Выберите дополнительные компоненты и действия:
...
InstallingLabel=Пожалуйста, подождите, пока выполняется подготовка системы.

; *** "Setup Completed" wizard page
FinishedHeadingLabel=Завершение работы [name]
FinishedLabelNoIcons=Работа [name] по подготовке системы завершена.
FinishedLabel=Программа [name] установлена на ваш компьютер. Приложение можно запустить с помощью соответствующего значка.
ClickFinish=Нажмите «Завершить», чтобы выйти из программы.
FinishedRestartLabel=Для применения изменений требуется перезагрузить компьютер. Произвести перезагрузку сейчас?
FinishedRestartMessage=Для применения изменений требуется перезагрузить компьютер.%n%nПроизвести перезагрузку сейчас?
...
CreateDesktopIcon=Создать значок на &Рабочем столе (для всех пользователей)
...
Msvcr=Установить Microsoft Visual C++ Redistributable Packages
Sysopts=Оптимизировать настройки системы
...
UnblFirewall=Добавить программу и её компоненты в список исключений брандмауэра Windows (все сети)
