...
WizardSelectTasks=Підготовка системи до роботи з Open Server Panel
SelectTasksDesc=Встановлення додаткових системних компонентів
SelectTasksLabel2=Виберіть додаткові компоненти та дії:
...
InstallingLabel=Будь ласка, зачекайте, поки виконується підготовка системи.

; *** Сторінка "Встановлення завершено"
FinishedHeadingLabel=Завершення роботи [name]
FinishedLabelNoIcons=Робота [name] з підготовки системи згідно з вимогами Open Server Panel завершена.
...
ClickFinish=Натисніть «Готово» для виходу з програми.
FinishedRestartLabel=Для застосування змін необхідно перезавантажити ваш комп’ютер. Перезавантажити комп’ютер зараз?
FinishedRestartMessage=Для застосування змін необхідно перезавантажити ваш комп’ютер.%n%nПерезавантажити комп’ютер зараз?
...
UnblFirewall=Додати програму та її компоненти до списку винятків брандмауера Windows (усі мережі)
